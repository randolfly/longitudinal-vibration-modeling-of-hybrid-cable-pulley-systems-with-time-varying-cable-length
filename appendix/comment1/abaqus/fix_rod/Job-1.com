...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'randolf',
    'listener_resource':'26964',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('randolf.tsinghua.edu.cn', 'randolf', '183.173.35.52', '192.168.56.1'),
    'mp_host_list':(('randolf', 2),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l randolf -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\randolf\\AppData\\Local\\Temp',
    'tracer':OFF,
